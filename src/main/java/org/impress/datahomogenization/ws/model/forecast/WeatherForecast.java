...
package org.impress.datahomogenization.ws.model.forecast;
...
public class WeatherForecast {
    ...
    private Integer cnt;
    @JsonProperty("list")
    private java.util.List<org.impress.datahomogenization.ws.model.forecast.List> list = new ArrayList<org.impress.datahomogenization.ws.model.forecast.List>();
    @JsonIgnore
     ...
     */
    @JsonProperty("list")
    public java.util.List<org.impress.datahomogenization.ws.model.forecast.List> getList() {
        return list;
    }
     ...
     */
    @JsonProperty("list")
    public void setList(java.util.List<org.impress.datahomogenization.ws.model.forecast.List> list) {
        this.list = list;
    }
